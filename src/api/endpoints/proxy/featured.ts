...
app.openapi({
  path: "/proxy/featured", method: "get",
      ...
      content: {
        "application/json": {
          schema: z.object({
            ...
            community_featured_studios: z.array(z.object({
            ...
            community_most_remixed_projects: z.array(z.object({
              ...project,
            ...
            scratch_design_studio: z.array(z.object({
